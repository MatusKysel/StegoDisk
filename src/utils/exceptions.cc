...
InvalidState::InvalidState(const Operation& operation,
                           const Component& component,
                           const ComponentState& state)
    : std::runtime_error{"Required operation '" + to_string(operation) +
                         "' can not be applied because of current state '" +
                         to_string(state) + "' of the component '" +
                         to_string(component) + "'"},
      operation_{operation}, component_{component}, state_{state} {}
